...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_confetti_bomb')) {
        Object.defineProperty(Module['ready'], '_confetti_bomb', { configurable: true, get: function() { abort('You are getting _confetti_bomb on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_confetti_bomb', { configurable: true, set: function() { abort('You are setting _confetti_bomb on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _confetti_bomb = Module["_confetti_bomb"] = createExportWrapper("confetti_bomb");
